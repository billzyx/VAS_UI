...
from vas_toolkit.excel_tools import get_xlsx_contents
...
def save_labels(txt_file_path, label_list):
    ...
    sheet.cell(row=2, column=1).value = os.path.basename(os.path.dirname(txt_file_path))
